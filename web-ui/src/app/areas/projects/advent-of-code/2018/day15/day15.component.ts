...
@Component({
  selector: 'app-2018-day15',
  templateUrl: './day15.component.html'
})
export class Day15_2018Component implements OnInit {
  ...
  private iterate() {
    ...
    this.child.updateValues(this._cave, this._combatants);
  ...
  private openDialog() {
    ...
    dialogConfig.data = { cave: this._cave, combatants: this._combatants };
