...
@Component({
  selector: 'app-2018-day18',
  templateUrl: './day18.component.html'
})
export class Day18_2018Component implements OnInit {
  _paused: boolean;
  _iteration: number;
  ...
  private iterateGround() {
    ...
    if (!this._paused && this._iteration < 10) {
      window.setTimeout(() => {
        this.iterateGround();
      }, 500);
    } else if (this._iteration === 10) {
