...
@Component({
  selector: 'app-day22-5',
  templateUrl: './day22-5.component.html'
})
export class Day22_5Component implements OnInit {
  ...
  private _burst(): void {
    if (this._grid[this._position.y][this._position.x] === '#') {
      this._turnRight();
      this._grid[this._position.y][this._position.x] = 'F';
    } else if (this._grid[this._position.y][this._position.x] === '.') {
      this._turnLeft();
      this._grid[this._position.y][this._position.x] = 'W';
    } else if (this._grid[this._position.y][this._position.x] === 'W') {
      this._infectedCount++;
      this._grid[this._position.y][this._position.x] = '#';
    } else if (this._grid[this._position.y][this._position.x] === 'F') {
